...
public class UserInterface {
    ...
    public UserInterface(Scanner input, Library library) {
        this.input = input;
        this.library = library;
    }

    public String promptAndReadTitle() {
        System.out.print("Title: ");
        return input.nextLine();
    }

    public int promptAndReadYear() {
    ...
    public void handleLibrarianSession() {
        char command = ' ';
        while (command != '0') {
            ...
            switch (command) {
                case '1':
                    ...
                    while (instruction != '0') {
                        ...
                        switch (instruction) {
                            case '1':
                                MediaItem book = createNewBookFromUserInput();
                                ...
                                break;
                            case '2':
                                MediaItem movie = createNewMovieFromUserInput();
                                ...
                                break;
                            case '3':
                                MediaItem musicAlbum = createNewMusicAlbumFromUserInput();
    ...
    public void handleMemberSession() {
        char command = ' ';
        while (command != '0') {
    ...
    public Book createNewBookFromUserInput() {
        System.out.println("\nLet's add a book");

        String title = promptAndReadTitle();

        int yearOfPublication = promptAndReadYear();
    ...
    public Movie createNewMovieFromUserInput() {
        System.out.println("\nLet's add a movie.");
    ...
    public MusicAlbum createNewMusicAlbumFromUserInput() {
